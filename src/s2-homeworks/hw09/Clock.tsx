...
function Clock() {
    ...
    let dateForm = new Intl.DateTimeFormat("ru", {
        day: 'numeric',
        month: 'numeric',
        year: 'numeric'
    })
    let dayForm = new Intl.DateTimeFormat("en-US", {
        weekday: 'long'
    })
    let monthForm = new Intl.DateTimeFormat("en-US", {
        month: 'long'
    })
    ...
    const stringDate = dateForm.format().toString() || <br/>
    // день.месяц.год (01.02.2022) // пишут студенты,
    // варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем

    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    const stringDay = dayForm.format().toString() || <br/> // пишут студенты
    const stringMonth = monthForm.format().toString() || <br/> // пишут студенты
